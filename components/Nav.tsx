...
export default function Nav({ onReset, locale = 'pt', onLocaleChange }: NavProps) {
  ...
  return (
    <nav style={{ paddingLeft: 'clamp(24px, 5vw, 60px)', paddingRight: 'clamp(24px, 5vw, 60px)' }}
      ...
      <div className="flex items-center gap-3">
        {/* Language toggle */}
        {onLocaleChange && (
          <div className="hidden md:flex items-center gap-1.5 font-mono text-xs border border-[var(--border-dim)] px-2.5 py-1.5">
            <button
              onClick={() => locale !== 'pt' && onLocaleChange()}
            ...
            <button
              onClick={() => locale !== 'en' && onLocaleChange()}
